...
* <img alt="GIF4" src="https://revistadigital.mx/wp-content/uploads/2023/02/Depositphotos_51226785_L.gif" width="30px" /> Learning IA in Talento Tech Program (Bootcamp of mintic).
...
1. 🤝 Became collaborator on [PatoProgramador/Employment-Exchange](https://github.com/PatoProgramador/Employment-Exchange)<br>
2. ⬆️ Pushed 1 commit(s) to [PatoProgramador/Employment-Exchange](https://github.com/PatoProgramador/Employment-Exchange)<br>
3. ⬆️ Pushed 1 commit(s) to [PatoProgramador/Employment-Exchange](https://github.com/PatoProgramador/Employment-Exchange)<br>
4. 📔 Created new repository [PatoProgramador/Employment-Exchange](https://github.com/PatoProgramador/Employment-Exchange)<br>
5. ⭐ Starred [AngelPuentesDevv/screenmatch](https://github.com/AngelPuentesDevv/screenmatch)<br>
<!--RECENT_ACTIVITY:end-->

<!--RECENT_ACTIVITY:last_update-->
Last Updated: Tuesday, May 7th, 2024, 11:35:50 AM
